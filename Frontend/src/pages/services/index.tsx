import { Button, Input, Modal, Rate, Select, Spin } from "antd";
...
import { Mail, Phone } from "lucide-react"; // Added for CTA section
...
const Services = () => {
  ...
  const services: Service[] = [
    {
      ...
      description:
        "Dịch vụ tư vấn toàn diện về sức khỏe sinh sản cho nam và nữ, bao gồm tư vấn về chu kỳ kinh nguyệt, kế hoạch hóa gia đình, và các vấn đề liên quan đến sức khỏe tình dục.",
    ...
    },
    {
      ...
      description:
        "Gói xét nghiệm toàn diện các bệnh lây truyền qua đường tình dục, bao gồm HIV, Giang mai, Lậu, Chlamydia và các STI khác với công nghệ hiện đại và kết quả chính xác.",
    ...
    },
    {
      ...
      description:
        "Dịch vụ tư vấn chuyên sâu cho các cặp đôi chuẩn bị kết hôn, bao gồm khám sức khỏe, tư vấn tâm lý và chuẩn bị cho cuộc sống hôn nhân.",
    ...
    },
    {
      ...
      description:
        "Dịch vụ theo dõi và tư vấn về chu kỳ kinh nguyệt, giúp phụ nữ hiểu rõ hơn về cơ thể và phát hiện sớm các bất thường.",
    ...
    },
    {
      ...
      description:
        "Dịch vụ tư vấn tâm lý chuyên sâu về các vấn đề tình dục, giúp giải quyết các rối loạn chức năng tình dục và cải thiện chất lượng cuộc sống tình dục.",
      shortDescription: "Tư vấn tâm lý về các vấn đề tình dục",
      image: Image5,
      price: { online: 350000, offline: 550000, home: 850000 },
      duration: "60 phút",
      category: "consultation",
      features: [
    ...
    },
    {
      ...
      description:
        "Dịch vụ chăm sóc sức khỏe tại nhà với đội ngũ y tá và bác sĩ chuyên nghiệp, mang đến sự tiện lợi và an toàn cho khách hàng.",
      shortDescription: "Dịch vụ chăm sóc sức khỏe tận nhà chuyên nghiệp",
      image: Image6,
      price: { online: 0, offline: 0, home: 1000000 },
  ...
  const sortedServices = [...filteredServices].sort((a, b) => {
    switch (sortBy) {
      ...
      case "price-high":
        return (b.price.online || b.price.offline) - (a.price.online || a.price.offline);
      case "newest":
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-green-50">
        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} className="text-center">
          <Spin size="large" />
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="mt-4 text-gray-600 font-medium">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      {/* Hero Section */}
      <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="relative h-[40vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#0C3C54] via-[#2A7F9E] to-sky-400 py-4">
        <div className="absolute inset-0">
          <motion.div
            animate={{ scale: [1, 1.1, 1] }}
            transition={{ duration: 20, repeat: Infinity }}
            className="absolute inset-0 bg-gradient-to-r from-[#0C3C54]/90 via-[#2A7F9E]/90 to-sky-400/90"
          />
          <div className="absolute inset-0 grid grid-cols-3 gap-0 opacity-20">
            {[Image1, Image2, Image3, Image4, Image5, Image6].map((img, index) => (
              <motion.div key={index} initial={{ opacity: 0, scale: 1.2 }} animate={{ opacity: 0.3, scale: 1 }} transition={{ delay: index * 0.2, duration: 1 }} className="relative overflow-hidden">
                <img src={img} alt={`Background ${index + 1}`} className="w-full h-full object-cover" onError={(e) => (e.currentTarget.src = "/fallback-image.jpg")} />
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Chăm sóc sức khỏe toàn diện với đội ngũ chuyên gia hàng đầu, công nghệ hiện đại và dịch vụ tận tâm
            </p>
          </motion.div>

          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.8 }} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              type="primary"
              size="large"
              className="bg-white text-[#0C3C54] border-none hover:bg-cyan-400 hover:text-white font-semibold px-8 py-6 h-auto text-lg rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
            ...
            <Button
              size="large"
              className="bg-transparent text-white border-2 border-white hover:bg-cyan-400 hover:text-[#0C3C54] font-semibold px-8 py-6 h-auto text-lg rounded-full transition-all duration-300 hover:scale-105"
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8, duration: 0.8 }} className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
        ...
        <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 2, repeat: Infinity }} className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white">
      ...
      <AnimatedSection className="py-6 bg-white/80 backdrop-blur-sm sticky top-0 z-40 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Sort size={18} className="text-gray-400" />
              <Select value={sortBy} onChange={setSortBy} size="middle" className="min-w-[120px]">
      ...
      <AnimatedSection className="py-10">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Dịch vụ Chăm sóc Sức khỏe</h2>
            <p className="text-base text-gray-600 max-w-2xl mx-auto">Khám phá các dịch vụ chuyên nghiệp được thiết kế riêng cho nhu cầu của bạn</p>
          </motion.div>
          <AnimatePresence mode="wait">
            ...
            >
              {sortedServices.map((service, index) => (
                ...
                >
                  <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow hover:shadow-lg transition-all duration-300 border border-white/10 p-3 min-h-[220px] flex flex-col justify-between">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="bg-white/40 rounded-full p-2 text-[#2A7F9E]">{service.icon}</div>
                      <span className="text-xs text-gray-500 ml-auto">{service.isNew && 'Mới'}</span>
                    </div>
                    <h3 className="text-base font-bold text-[#0C3C54] mb-1 line-clamp-2">{service.name}</h3>
                    <p className="text-xs text-gray-700 mb-2 line-clamp-2">{service.shortDescription}</p>
                    <div className="flex flex-wrap gap-1 mb-2">
                      {service.features.slice(0, 2).map((feature, i) => (
                        <span key={i} className="bg-[#2A7F9E]/10 text-[#2A7F9E] px-2 py-0.5 rounded-full text-[10px] font-medium">
                          {feature}
                        </span>
                      ))}
                    </div>
                    <div className="flex items-center justify-between mt-auto">
                      <span className="text-sm font-semibold text-[#2A7F9E]">{formatPrice(service.price.online)}</span>
                      <Button
                        type="primary"
                        className="bg-[#2A7F9E] text-white rounded-full px-4 py-1 text-xs font-semibold shadow hover:bg-cyan-400 hover:text-[#0C3C54] transition-all duration-200"
                        onClick={(e) => {
                          e.stopPropagation();
      ...
      <AnimatedSection className="py-20 bg-gradient-to-br from-blue-50 via-purple-50 to-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Gói Dịch vụ Đặc biệt</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Tiết kiệm chi phí với các gói dịch vụ được thiết kế đặc biệt, mang lại giá trị tối ưu cho sức khỏe của bạn</p>
          </motion.div>
              ...
              >
                {pkg.isRecommended && (
                  <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <span className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-2 rounded-full text-sm font-semibold shadow-lg">Được khuyến nghị</span>
                  </div>
                )}
                ...
                <div className="p-6">
                  ...
                  <div className="mb-6">
                    <div className="flex items-baseline gap-2 mb-2">
                      <span className="text-3xl font-bold text-blue-600">{formatPrice(pkg.discountPrice)}</span>
                      <span className="text-lg text-gray-400 line-through">{formatPrice(pkg.originalPrice)}</span>
                    </div>
                    <div className="text-sm text-green-600 font-semibold">Tiết kiệm {formatPrice(pkg.originalPrice - pkg.discountPrice)}</div>
                  </div>
                  <div className="mb-6">
                  ...
                  <Button
                    ...
                    size="large"
                    className={`${
                      pkg.isRecommended ? "bg-gradient-to-r from-blue-500 to-purple-500 border-none hover:from-blue-600 hover:to-purple-600" : "bg-gray-800 border-none hover:bg-gray-700"
      ...
      <AnimatedSection className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Khách hàng Nói gì về Chúng tôi</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">Hàng nghìn khách hàng đã tin tưởng và hài lòng với dịch vụ của chúng tôi</p>
          </motion.div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="mb-6">
                  ...
                  />
                  <Rate disabled defaultValue={testimonials[currentTestimonial].rating} className="text-yellow-500 mb-4" />
                </div>
                <blockquote className="text-xl md:text-2xl text-gray-700 font-medium mb-6 italic">"{testimonials[currentTestimonial].comment}"</blockquote>
                <div className="text-center">
                  <div className="font-semibold text-gray-900 text-lg">{testimonials[currentTestimonial].name}</div>
                  <div className="text-blue-600 text-sm">{testimonials[currentTestimonial].service}</div>
                </div>
              </motion.div>
            </AnimatePresence>
            <div className="flex justify-center mt-8 gap-2">
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${index === currentTestimonial ? "bg-blue-500 w-8" : "bg-gray-300 hover:bg-gray-400"}`}
                />
              ))}
            </div>
          </div>
      ...
      <AnimatedSection className="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-green-600 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Sẵn sàng Chăm sóc Sức khỏe của Bạn?</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Đừng để sức khỏe chờ đợi. Đặt lịch tư vấn ngay hôm nay và nhận được sự chăm sóc tốt nhất từ đội ngũ chuyên gia của chúng tôi.
            </p>
      ...
      <Modal
        ...
        styles={{ body: { padding: 0 }, mask: { backdropFilter: "blur(10px)" } }}
      >
        {selectedService && (
          <div className="relative">
            <div className="relative h-64 overflow-hidden">
              <img src={selectedService.image} alt={selectedService.name} className="w-full h-full object-cover" onError={(e) => (e.currentTarget.src = "/fallback-image.jpg")} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-blue-600">{formatPrice(selectedService.price.online)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Tại phòng khám:</span>
                        <span className="font-semibold text-blue-600">{formatPrice(selectedService.price.offline)}</span>
                      </div>
                      {selectedService.price.home && (
                        <div className="flex justify-between">
                          <span>Tại nhà:</span>
                          <span className="font-semibold text-blue-600">{formatPrice(selectedService.price.home)}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <Button block size="large" className="font-semibold rounded-xl h-12" icon={<Call size={20} />}>
