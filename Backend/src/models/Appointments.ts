...
export interface IAppointments {
  ...
  description?: string;
  notes?: string;
  status: "pending" | "pending_payment" | "confirmed" | "completed" | "cancelled" | "payment_cancelled" | "expired";
...
const AppointmentsSchema = new mongoose.Schema<IAppointments>({
  ...
  status: {
    type: String,
    enum: ["pending", "pending_payment", "confirmed", "completed", "cancelled", "payment_cancelled", "expired"],
