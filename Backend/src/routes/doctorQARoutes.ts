...
// GET /api/doctor-qa - Lấy tất cả yêu cầu tư vấn (có thể filter) - STAFF ONLY
...
// PUT /api/doctor-qa/:id/schedule - Staff xếp lịch cụ thể
router.put('/doctor-qa/:id/schedule', verifyToken, verifyStaff, scheduleQA);

// PUT /api/doctor-qa/:id/status - Cập nhật trạng thái tổng quát
router.put('/doctor-qa/:id/status', verifyToken, verifyStaff, updateQAStatus);

// DELETE /api/doctor-qa/:id - Xóa yêu cầu tư vấn
